...
ALLOWED_MESSAGE_TYPES = [TextMessage, LinkMessage, PictureMessage, ScanDataMessage, StartChattingMessage,
...
def incoming():
    ...
    try:
        ...
        try:
            print app.log.error(
                "Custom Logging Failed! Error: {}, Message: {}, Response:{}, extraData:{}".format(e, message,
                                                                                                  out_messages,
                                                                                                  event))
        except Exception as e:
